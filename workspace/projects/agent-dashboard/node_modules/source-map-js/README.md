...
More important that WASM version has some optimizations in JS code too. This is why [community asked to create branch for 0.6 version]([PRIVATE_URL_WITH_CREDENTIALS] with no response at all.

[Roman Dvornov (@lahmatiy)]([PRIVATE_URL_WITH_CREDENTIALS] This article contains optimizations and hacks that lead to almost the same performance compare to WASM implementation.
