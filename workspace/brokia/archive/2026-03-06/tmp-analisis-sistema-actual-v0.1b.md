...
A continuación se describe el flujo operativo por procesos. Los tiempos presentados se entienden como rangos **preliminares** (no línea base final). Cuando existen métricas ya relevadas para subprocesos, se incorporan explícitamente.
...
**Dónde se acumula retrabajo (observado):**
- normalización de datos y completitud (pedidos reiterados),
- traducción de campos entre portales,
- reingreso de información.

**Métrica preliminar ya relevada (subproceso 001 — “Cotización multicompañía de vehículo”):**
- **Tiempo P50:** 20 minutos
- **Tiempo P90:** 40 minutos
- **Frecuencia mensual:** 150 cotizaciones
- **Carga:** 4/5
- **Riesgo:** 5/5
- **Retrabajo estimado:** 15%

Estos valores aportan una primera cuantificación del costo operativo del flujo de cotización cuando el corredor opera manualmente con múltiples portales.
...
**Métricas preliminares ya relevadas (subproceso 002 — “Anulación de póliza”):**
- **Tiempo P50:** 5 minutos
- **Tiempo P90:** 10 minutos
- **Frecuencia mensual:** 5 anulaciones
- **Carga:** 2/5
- **Riesgo:** 2/5
- **Retrabajo estimado:** 5%

La baja frecuencia relativa contrasta con el hecho de que, cuando el subproceso se integra en escenarios más amplios (p. ej., cambio de vehículo), su coordinación puede amplificar fricción e incertidumbre percibida por el cliente.
...
### 3.6 Proceso superior (ejemplo): cambio de vehículo
En el material operativo relevado, se modeló el **proceso 100 — “Cambio de vehículo”** como un proceso superior que integra subprocesos de alta fricción:

- incluye subproceso **001 (Cotización multicompañía)** y subproceso **002 (Anulación de póliza)**,
- requiere comparar escenarios (endoso en compañía actual, anular y emitir nueva póliza, mantener hasta vencimiento y cambiar luego),
- combina decisión comercial, gestión operativa e impacto económico.

**Métricas preliminares del proceso 100:**
- **Tiempo P50:** 40 minutos
- **Tiempo P90:** 55 minutos
- **Frecuencia mensual:** 3 (promedio), con picos de 8–10 en temporadas
- **Carga:** 4/5
- **Riesgo:** 4/5
- **Retrabajo estimado:** 20% (principalmente por información insuficiente o ambigua del vehículo)

La relevancia de este proceso es conceptual: ilustra cómo los subprocesos se encadenan y cómo el retrabajo se acumula cuando la información inicial no es completa o cuando existen dependencias externas.
...
**Ejemplos concretos (sin inventar datos):**
- iteraciones sucesivas por documentación requerida para destrabar emisión o cambios,
- tiempos de espera asociados a la canalización de excepciones hacia la compañía,
...
La evidencia preliminar de cada hipótesis se expresa, por ahora, en patrones del sistema (flujos, fricciones y tensiones) y en métricas ya relevadas para subprocesos específicos. La validación empírica posterior determinará prioridad y medibilidad.
