# Brokia — Anexo metodológico de validación (v0.1)

**Fecha:** 2026-03-04  
**Estado:** anexo metodológico (detalle completo)  
**Alcance:** Gate 1A (corredores) + Gate 1B (clientes) + instrumentos + mapa conceptual + tablas

---

## A) Gate 1A (corredores) — metodología e instrumentos

### A.1 Metodología Gate 1A (definición Top 3, conteo y umbrales)
...
### A.2 Guion operativo de entrevista (v0.2)
...
### A.3 Plantilla de registro de entrevista (v0.2)
...
### A.4 Guía de mapeo de núcleos (v0.1)
...
### A.5 Tabla de conteo Top 3 (v0.2)
# Gate 1 — Conteo acumulativo Top 3 (v0.2)

**Fecha:** 2026-03-03  
**Version:** v0.2 (editable)

---

## Instrucciones de uso (breves)
1) Por cada entrevista, marcar con **1** si el nucleo aparece en el **Top 3 declarado** por el entrevistado.
2) Completar “Notas” con el Top 3 literal (ej.: A/C/E) y cualquier aclaracion de mapeo.
3) Al llegar a N entrevistas (5/8/10), completar el resumen manual y evaluar umbrales segun `gate1-metodologia-validacion-v0.1.md`.

---

## Reglas de conteo y mapeo (breve)
- Por cada item del **Top 3** se debe asignar **un (1) nucleo dominante** (A/B/C/D/E) para el conteo.
- Si el dolor es mixto, registrar el nucleo **secundario** en “Notas”, pero **no** duplicar conteo.
- El objetivo del conteo es comparabilidad entre entrevistas: la regla 1 item = 1 nucleo es obligatoria.

---

## Tabla de conteo (espacio para minimo 10 entrevistas)

| # Entrevista | Fecha | A | B | C | D | E | Top 3 literal | Notas |
|---:|---|---:|---:|---:|---:|---:|---|---|
| 1 |  |  |  |  |  |  |  |  |
| 2 |  |  |  |  |  |  |  |  |
| 3 |  |  |  |  |  |  |  |  |
...
## Resumen (completar manualmente)

- **N entrevistas completadas:**
...
### Observaciones
- ¿Que nucleos aparecen con mayor consistencia?
- ¿Hay sesgo por perfil (p. ej., solo agencias vs solo individuales)?
- ¿Hay dolor “mixto” que requiera redefinir mapeo?

### Decision preliminar
- Nucleo candidato #1:
- Nucleo candidato #2 (si aplica):
- Pendiente de:

---

## B) Gate 1B (clientes) — metodología e instrumentos

### B.1 Metodología de encuesta (v0.1)
...
### B.3 Plantilla de análisis de resultados (v0.1)
...
## C) Mapa conceptual actualizado (v0.3)
...
## D) Tabla comparativa de núcleos (A/B/C/D/E) (v0.2)
...
## E) Nota sobre criterios de validación
Los criterios Gate 1 (Top 3, conteo, umbrales, métricas base, ejemplo concreto y prueba práctica) se encuentran explicitados en el apartado A.1.
